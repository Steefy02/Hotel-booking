                                    ...
                                    <li>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" style="position: absolute;">
                                                <li><a href="{{route('home')}}" style="color:black; height:20px; padding-top:0px;">Pagina principala</a></li>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card mb-4" style="opacity: 0.85;">
                        <div id="card1" class="card-body" style="cursor: pointer;">
                            ...
                            <div class="card-subtitle mb-3" style="color: #02B884;">Actualizati-va informatiile.</div>
                        </div>
                    </div>
                </div>
